...
CREATE TABLE Students ( StudentID INT (10) PRIMARY KEY,StudentNAME VARCHAR (20),Gender VARCHAR (20),DepartmentID INT (20) );
INSERT INTO Students (StudentID,StudentNAME,Gender,DepartmentID)
